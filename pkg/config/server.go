...
type ServerCommonConf struct {
	...
	//VhostHTTPSRPPort specifies the port that the server listens for HTTPS Vhost
	// requests. If this value is 0, the server will not listen for HTTPS reverse proxy
	// requests. By default, this value is 0.
	VhostHTTPSRPPort int `ini:"vhost_https_reserve_proxy_port" json:"vhost_https_reserve_proxy_port" validate:"gte=0,lte=65535"`
