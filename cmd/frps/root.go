...
func init() {
	...
	rootCmd.PersistentFlags().IntVarP(&vhostServerHTTPSPort, "vhost_server_https_port", "", 0, "vhost server https proxy port")
...
func parseServerCommonCfgFromCmd() (cfg config.ServerCommonConf, err error) {
	...
	cfg.VhostServerHTTPPSPort = vhostServerHTTPSPort
